...
<button onclick="priceSort()" style="margin:27%;display:block;font-family:Raleway;text-align:center;background-color:transparent;border-style:solid;width:200px;height:40px;font-weight:bold;border-radius:15px">Request Products for the Children's Shoppe</button>

...
<form action = "/home" class = "top-of-page-nav-bar-form" method = "POST"><button onmouseover = "backColorChange('home-button','#63ba11','white');borderBottomAppear('home-button','white','black')" onmouseleave = "backColorChange('home-button','#63ba11','white');borderBottomAppear('home-button','white','black')" id = "home-button" class = "top-of-page-nav-bar-form-button" type = "submit">Home</button></form>
<form action = "/services" class = "top-of-page-nav-bar-form" method = "POST"><button id = "services-button" onmouseover = "backColorChange('services-button','#63ba11','white');borderBottomAppear('services-button','white','black')" onmouseleave = "backColorChange('services-button','#63ba11','white');borderBottomAppear('services-button','white','black')" class = "top-of-page-nav-bar-form-button" type = "submit">Services</button></form>
<form action = "/contact" class = "top-of-page-nav-bar-form" method = "POST"><button id = "contact-button" onmouseover = "backColorChange('contact-button','#63ba11','white');borderBottomAppear('contact-button','white','black')" onmouseleave =  "backColorChange('contact-button','#63ba11','white');borderBottomAppear('contact-button','white','black')" class = "top-of-page-nav-bar-form-button" type = "submit">Contact</button></form>
<form action = "/hiring" class = "top-of-page-nav-bar-form" method = "POST"><button id = "hiring-button" onmouseover = "backColorChange('hiring-button','#63ba11','white');borderBottomAppear('hiring-button','white','black')" onmouseleave = "backColorChange('hiring-button','#63ba11','white');borderBottomAppear('hiring-button','white','black')"  class = "top-of-page-nav-bar-form-button" type = "submit">Hiring</button></form>

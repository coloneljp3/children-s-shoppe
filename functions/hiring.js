...
<div class="sub-hiring-forms"><h2 class="sub-hiring-form-headers"></h2><label>Please type below...</label><input placeholder="Please type in..."></div>
    <div class="sub-hiring-forms"><h2 class="sub-hiring-form-headers"></h2><label>Please type below...</label><input placeholder="Please type in..."></div>
    <div class="sub-hiring-forms"><h2 class="sub-hiring-form-headers"></h2><label>Please type below...</label><input placeholder="Please type in..."></div>
    <div class="sub-hiring-forms"><h2 class="sub-hiring-form-headers"></h2><label>Please type below...</label><input placeholder="Please type in..."></div>
</div>
<div class="hiring-forms" id="hiring-work-history"><h1 class="hiring-form-headers">Children's Shoppe Work History Form</h1><div class="sub-hiring-forms"><h2 class="sub-hiring-form-headers"></h2><label>Please type below...</label><input placeholder="Please type in..."></div>
    <div class="sub-hiring-forms"><h2 class="sub-hiring-form-headers"></h2><label>Please type below...</label><input placeholder="Please type in..."></div>
    <div class="sub-hiring-forms"><h2 class="sub-hiring-form-headers"></h2><label>Please type below...</label><input placeholder="Please type in..."></div>
    <div class="sub-hiring-forms"><h2 class="sub-hiring-form-headers"></h2><label>Please type below...</label><input placeholder="Please type in..."></div></div>
<div class="hiring-forms" id="hiring-references"><h1 class="hiring-form-headers">Children's Shoppe Work References Form</h1><div class="sub-hiring-forms"><h2 class="sub-hiring-form-headers"></h2><label>Please type below...</label><input placeholder="Please type in..."></div>
    <div class="sub-hiring-forms"><h2 class="sub-hiring-form-headers"></h2><label>Please type below...</label><input placeholder="Please type in..."></div>
    <div class="sub-hiring-forms"><h2 class="sub-hiring-form-headers"></h2><label>Please type below...</label><input placeholder="Please type in..."></div>
    <div class="sub-hiring-forms"><h2 class="sub-hiring-form-headers"></h2><label>Please type below...</label><input placeholder="Please type in..."></div></div>
<div class="hiring-forms" id="hiring-preferences"><h1 class="hiring-form-headers">Hiring Preferences</h1><div class="sub-hiring-forms"><h2 class="sub-hiring-form-headers"></h2><label>Please type below...</label><input placeholder="Please type in..."></div>
    <div class="sub-hiring-forms"><h2 class="sub-hiring-form-headers"></h2><label>Please type below...</label><input placeholder="Please type in..."></div>
    <div class="sub-hiring-forms"><h2 class="sub-hiring-form-headers"></h2><label>Please type below...</label><input placeholder="Please type in..."></div>
    <div class="sub-hiring-forms"><h2 class="sub-hiring-form-headers"></h2><label>Please type below...</label><input placeholder="Please type in..."></div></div>
...
<div><h1 style = "text-align: center;">Application</h1>
<form action = "/.netlify/functions/hiring_sub" type = "submit" method = "post" style = "text-align: center;">Education Level<select onchange = "handleChange('select','edu')" id = "select"><option value = "null">Select current enrollment level</option><option value = "Elementary">Elementary School(1 - 5)</option><option value = "Middle School">Middle School(6 - 8)</option><option value = "High School">High School(9 - 12)</option><option value = "College">College(2-4 year degree)</option><option value = "N/A">Not Applicable</option></select><input style = "display:none" id = "edu" name = "education"/><br><br><div><span>First Name<input name = "first_name" placeholder = "First Name"/></span><br><br><span>Last Name<input name = "last_name"placeholder = "Last Name"/></span><br><br><span>Email<input name = "email_user" placeholder = "email_user"/></span><br><br><span>Cell Phone Number<input name = "cell"placeholder = "Cell"/></span><br><br><span>What is your work experience/qualifications?(Type information in text box below)<br><textarea name = "exp" cols = "50" rows = "5"></textarea></span><br><br><span>What are some of your good personality traits? What are your weak traits?(Type information in text box below)<br><textarea name = "char" cols = "50" rows = "5"></textarea></span></div><button type = "submit">Submit Form</button></form></div><script>function handleChange(id,id_2){var inp = document.getElementById(id);var selinp = inp.options[inp.selectedIndex].value;if(selinp == ""){document.getElementById(id_2).value = 'null'}else{document.getElementById(id_2).value = selinp;}}</script><input value = "undefined" name = "user" style = "display:none"/><footer style="background-color:#7ab37a"></footer>
</div>
